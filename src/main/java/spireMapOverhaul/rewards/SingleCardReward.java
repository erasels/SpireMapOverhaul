...
public class SingleCardReward extends CustomReward {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(SpireAnniversary6Mod.makeID("SingleCardReward"));
    ...
    public SingleCardReward(AbstractCard c) {
        super((Texture) null, "", SMO_SINGLECARDREWARD);
        card = c;
        init();
    }
        ...
        if(args.length == 1 && args[0].contains("|")) {
            ...
            switch (args.length) {
                ...
                case 1:
                    ...
                    break;
                default:
                    SpireAnniversary6Mod.logger.warn(String.format("Tried to generate a SingleCardReward with %d parameters.\nInput: %s", args.length, Arrays.toString(args)));
