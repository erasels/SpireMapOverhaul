    ...
    public static class GetMovePatch {
        ...
        public static SpireReturn<Void> Foo(Chosen __instance) {
            ...
            if (AbstractDungeon.ascensionLevel >= 17) {
                ...
                __instance.setMove((byte) 5, AbstractMonster.Intent.ATTACK, __instance.damage.get(2).base, 2, true);
            }
    ...
    public static class TakeTurnPatch {
        ...
        public static SpireReturn<Void> Foo(Chosen __instance) {
            ...
            if (__instance.nextMove == 5) {
                ...
                AbstractDungeon.actionManager.addToBottom(new DamageAction(AbstractDungeon.player, __instance.damage.get(2), AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
                AbstractDungeon.actionManager.addToBottom(new DamageAction(AbstractDungeon.player, __instance.damage.get(2), AbstractGameAction.AttackEffect.SLASH_VERTICAL));
                __instance.setMove((byte) 4, AbstractMonster.Intent.STRONG_DEBUFF);
                ...
                __instance.setMove((byte) 3, AbstractMonster.Intent.ATTACK_DEBUFF, __instance.damage.get(1).base);
            } else if (__instance.nextMove == 3) {
                AbstractDungeon.actionManager.addToBottom(new AnimateSlowAttackAction(__instance));
                AbstractDungeon.actionManager.addToBottom(new DamageAction(AbstractDungeon.player, __instance.damage.get(1), AbstractGameAction.AttackEffect.SLASH_HEAVY));
                ...
                __instance.setMove((byte) 1, AbstractMonster.Intent.ATTACK, __instance.damage.get(0).base);
