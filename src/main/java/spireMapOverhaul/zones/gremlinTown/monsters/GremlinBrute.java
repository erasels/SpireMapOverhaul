...
public class GremlinBrute extends CustomMonster
{
    ...
    private static final int HP_MIN_A8 = 52;
    private static final int HP_MAX_A8 = 56;
    private static final int SLAM_DMG = 10;
    private static final int BREAK_DMG = 5;
    private static final int SLAM_DMG_A3 = 11;
    private static final int BREAK_DMG_A3 = 6;
