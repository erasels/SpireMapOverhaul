...
public class GremlinRiderBlue extends CustomMonster
{
    public static final String ID = SpireAnniversary6Mod.makeID(GremlinRiderBlue.class.getSimpleName());
    public static final String NAME;
    private static final String[] MOVES;
    private static final String SKELETON_ATLAS = SpireAnniversary6Mod.makeImagePath(
            "monsters/GremlinTown/GremlinRiderBlue/GremlinRider.atlas");
    private static final String SKELETON_JSON = SpireAnniversary6Mod.makeImagePath(
            "monsters/GremlinTown/GremlinRiderBlue/GremlinRider.json");
    ...
    private static final int TACTICAL_FRAIL = 2;
    private static final int TACTICAL_FRAIL_A17 = 3;
    ...
    public GremlinRiderBlue() {
        this(0.0f, 0.0f);
    }

    public GremlinRiderBlue(final float x, final float y) {
        super(GremlinRiderBlue.NAME, ID, MAX_HP, 0, 0, 180.0f, 200.0f, null, x, y);
    ...
    public void takeTurn() {
        ...
        switch (nextMove) {
            ...
            case TACTICAL_ATTACK:
                ...
                if (asc() < 17)
                    atb(new ApplyPowerAction(adp(), this, new FrailPower(adp(), TACTICAL_FRAIL, true)));
                else
                    atb(new ApplyPowerAction(adp(), this, new FrailPower(adp(), TACTICAL_FRAIL_A17, true)));
        }
