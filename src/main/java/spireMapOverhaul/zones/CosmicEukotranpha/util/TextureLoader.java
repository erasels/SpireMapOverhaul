...
import static spireMapOverhaul.zones.CosmicEukotranpha.CosmicZoneMod.imagePath;
import static spireMapOverhaul.zones.CosmicEukotranpha.CosmicZoneMod.powerPath;
...
public class TextureLoader {
        ...
        if (textures.get(filePath) == null) {
            try {
                ...
                try
                {
                    ...
                    CosmicZoneMod.logger.info("missing.png is missing!");
                    return null;
                }
            }
        }
    ...
    private static void loadTexture(final String textureString, boolean linearFilter) throws GdxRuntimeException {
        ...
        CosmicZoneMod.logger.info("Loaded texture " + textureString);
