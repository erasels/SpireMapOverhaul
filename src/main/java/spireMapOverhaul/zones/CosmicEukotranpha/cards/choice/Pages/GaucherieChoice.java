...
public class GaucherieChoice extends BaseCard{public static String ID=SpireAnniversary6Mod.makeID(GaucherieChoice.class.getSimpleName());
    public GaucherieChoice(){super(ID,-2,SKILL,SELF,SPECIAL,COLORLESS);}
