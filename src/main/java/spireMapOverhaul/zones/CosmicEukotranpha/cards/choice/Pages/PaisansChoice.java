...
public class PaisansChoice extends BaseCard{public static String ID=SpireAnniversary6Mod.makeID(PaisansChoice.class.getSimpleName());
    public PaisansChoice(){super(ID,-2,SKILL,SELF,SPECIAL,COLORLESS);}
