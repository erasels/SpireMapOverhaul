...
public class OdometryChoice extends BaseCard{public static String ID=SpireAnniversary6Mod.makeID(OdometryChoice.class.getSimpleName());
    public OdometryChoice(){super(ID,-2,SKILL,SELF,SPECIAL,COLORLESS);}
