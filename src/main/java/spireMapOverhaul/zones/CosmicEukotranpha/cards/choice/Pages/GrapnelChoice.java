...
public class GrapnelChoice extends BaseCard{public static String ID=SpireAnniversary6Mod.makeID(GrapnelChoice.class.getSimpleName());
    public GrapnelChoice(){super(ID,-2,SKILL,SELF,SPECIAL,COLORLESS);}
