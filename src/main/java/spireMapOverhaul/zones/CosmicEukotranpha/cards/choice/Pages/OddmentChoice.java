...
public class OddmentChoice extends BaseCard{public static String ID=SpireAnniversary6Mod.makeID(OddmentChoice.class.getSimpleName());
    public OddmentChoice(){super(ID,-2,SKILL,SELF,SPECIAL,COLORLESS);}
