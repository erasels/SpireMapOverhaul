...
public class NopalesChoice extends BaseCard{public static String ID=SpireAnniversary6Mod.makeID(NopalesChoice.class.getSimpleName());
    public NopalesChoice(){super(ID,-2,SKILL,SELF,SPECIAL,COLORLESS);}
