...
public class InsectOcianyvy extends CosmicZoneMonster{public InsectOcianyvy(){this(0.0F,0.0F);}public static final String ID=
        SpireAnniversary6Mod.makeID(InsectOcianyvy.class.getSimpleName());private static final MonsterStrings monsterStrings=CardCrawlGame.languagePack.getMonsterStrings(ID);public static final String NAME=monsterStrings.NAME;public static final String[]MOVES=monsterStrings.MOVES;public static final String[]DIALOG=monsterStrings.DIALOG;
    public int A=0;
    public InsectOcianyvy(float x,float y){super(NAME,ID,80,0.0F,-15.0F,120.0F,80.0F,null,x,y);MOVERS=MOVES;
        ...
        genMovePlus("Cosmic Buzz",aM(14,15,15,17),Intent.ATTACK_DEBUFF);
    ...
    public void takeTurn(){switch(this.nextMove){
        case 0:monsterDmg();pofP(new ConstrictedPower(AbstractDungeon.player,this,2));A=1;break;
        case 1:poS(new ArtifactPower(this,4));A=0;break;
        default:loggeer("ERROR, takeTurn outside switch, Insect Ocianyvy, Neptune");
