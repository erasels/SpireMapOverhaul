...
import spireMapOverhaul.zones.CosmicEukotranpha.powers.monstersOnly.BOnPlayCardPower;
...
public class InsectBarceq extends CosmicZoneMonster{public InsectBarceq(){this(0.0F,0.0F);}public static final String ID=
        SpireAnniversary6Mod.makeID(InsectBarceq.class.getSimpleName());private static final MonsterStrings monsterStrings=CardCrawlGame.languagePack.getMonsterStrings(ID);public static final String NAME=monsterStrings.NAME;public static final String[]MOVES=monsterStrings.MOVES;public static final String[]DIALOG=monsterStrings.DIALOG;
    public int A=0;
    public InsectBarceq(float x,float y){super(NAME,ID,80,0.0F,-15.0F,120.0F,80.0F,null,x,y);MOVERS=MOVES;
    ...
    public void takeTurn(){switch(this.nextMove){
        case 0:monsterDmg();pofP(new EnergizedPower(AbstractDungeon.player,1));A=1;break;
        case 1:poS(new BOnPlayCardPower(this,this,2));A=0;break;
        default:loggeer("ERROR, takeTurn outside switch, Insect Barceq, Jupiter");
