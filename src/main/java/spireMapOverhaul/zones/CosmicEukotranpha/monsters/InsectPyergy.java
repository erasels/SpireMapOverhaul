...
public class InsectPyergy extends CosmicZoneMonster{public InsectPyergy(){this(0.0F,0.0F);}public static final String ID=
        SpireAnniversary6Mod.makeID(InsectPyergy.class.getSimpleName());private static final MonsterStrings monsterStrings=CardCrawlGame.languagePack.getMonsterStrings(ID);public static final String NAME=monsterStrings.NAME;public static final String[]MOVES=monsterStrings.MOVES;public static final String[]DIALOG=monsterStrings.DIALOG;
    public int A=0;
    public InsectPyergy(float x,float y){super(NAME,ID,80,0.0F,-15.0F,120.0F,80.0F,null,x,y);MOVERS=MOVES;
    ...
    public void takeTurn(){switch(this.nextMove){
        case 0:monsterDmg();pofP(new ForesightPower(AbstractDungeon.player,4));A=1;break;
        case 1:poS(new StrengthPower(this,4));A=0;break;
        default:loggeer("ERROR, takeTurn outside switch, Insect Pyergy, Mars");
