...
public class DToFoesOnGainBUntilTurnEndPower extends BasePower implements CloneablePowerInterface{
    public static final String POWER_ID=SpireAnniversary6Mod.makeID(DToFoesOnGainBUntilTurnEndPower.class.getSimpleName());private static final PowerStrings powerStrings=CardCrawlGame.languagePack.getPowerStrings(POWER_ID);public static final String NAME=powerStrings.NAME;public static final String[]DESCRIPTIONS=powerStrings.DESCRIPTIONS;
    public int qqq=0;
    public DToFoesOnGainBUntilTurnEndPower(AbstractCreature o,AbstractCreature s,int amount){super(POWER_ID);this.owner=o;this.source=s;
        this.canGoNegative=false;this.isTurnBased=false;this.type=PowerType.BUFF;this.amount=amount;updateDescription();}
    @Override public void onGainedBlock(float blockAmount){dmgAll(amount);}
    ...
    @Override public AbstractPower makeCopy(){return new DToFoesOnGainBUntilTurnEndPower(owner,source,amount);}}
//Next turn: On gain B: 1 D to foes