...
public class LunaFloraAstrelliaQueenSolarSystemQueenPower extends BasePower implements CloneablePowerInterface{
    public static final String POWER_ID=SpireAnniversary6Mod.makeID(LunaFloraAstrelliaQueenSolarSystemQueenPower.class.getSimpleName());private static final PowerStrings powerStrings=CardCrawlGame.languagePack.getPowerStrings(POWER_ID);public static final String NAME=powerStrings.NAME;public static final String[]DESCRIPTIONS=powerStrings.DESCRIPTIONS;
    public int qqq=0;
    public LunaFloraAstrelliaQueenSolarSystemQueenPower(AbstractCreature o,AbstractCreature s){super(POWER_ID);this.owner=o;this.source=s;
    ...
    @Override public AbstractPower makeCopy(){return new LunaFloraAstrelliaQueenSolarSystemQueenPower(owner,source);}}


//Just a description power