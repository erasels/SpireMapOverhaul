...
public class BanditLieutenant extends CustomMonster {
    ...
    public BanditLieutenant(final float x, final float y) {
        ...
        this.loadAnimation(SpireAnniversary6Mod.makeMonsterPath("ThievesHideout/BanditLieutenant/skeleton.atlas"), SpireAnniversary6Mod.makeMonsterPath("ThievesHideout/BanditLieutenant/skeleton.json"), 1.0F);
